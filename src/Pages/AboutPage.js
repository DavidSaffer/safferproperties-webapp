    ...
    <div className={styles.aboutContainer}>
      ...
      >
        ...
        <div className={styles.serviceSection}>
          ...
          <p>
            3 to 5 bedroom homes in North Arlington, featuring diverse architectural styles such as ramblers,
            colonials, and expanded bungalows with unique amenities like tiki bars.
          </p>
        </div>
        <div className={styles.serviceSection}>
          <h4>Commercial Leasing</h4>
          <p>Our strategically located commercial properties are designed to cater to diverse business needs, featuring modern facilities and flexible floor plans.</p>
        </div>
        <div className={styles.serviceSection}>
